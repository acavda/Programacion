...
public class Billar2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Picture pic = new Picture("D:/imagenes/suelo5.png");
		pic.translate(0, 0);
		pic.draw();

		Picture billar = new Picture("D:/imagenes/tablero7.png");
		billar.translate(minx - 30, miny - 30);
		billar.draw();

		Picture win = new Picture("D:/imagenes/win.jpg");
		win.translate(0, 0);

		Picture botellas = new Picture("D:/imagenes/botellas3.png");
		botellas.translate(50, 25);
		botellas.draw();

		Picture botellas2 = new Picture("D:/imagenes/botellas3.png");
		botellas2.translate(max + minx + 50, 25);
		botellas2.draw();

		Picture botellas3 = new Picture("D:/imagenes/botellas3.png");
		botellas3.translate(50, maxy / 2 + 30);
		botellas3.draw();

		Picture botellas4 = new Picture("D:/imagenes/botellas3.png");
