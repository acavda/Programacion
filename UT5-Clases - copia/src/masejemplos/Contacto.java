...
public class Contacto {
	...
	public Contacto(String name,String ap1,String movil){
		this.nombre=name;
		this.apellido1=ap1;
		this.telMovil=movil;
	}
	
	public Contacto(String name,String ap1,String ap2,String movil){
		this.nombre=name;
		this.apellido1=ap1;
		this.apellido2=ap2;
		this.telMovil=movil;
	...
	public Contacto(String name,String ap1,String ap2,String dir,String movil,String fijo,String correo){
		this.nombre=name;
		this.apellido1=ap1;
		this.apellido2=ap2;
		this.direccion=dir;
